...
#define LEFTROTATE(x, c) (((x) << (c)) | ((x) >> (32 - (c))))
  ...
  inline uint32_t h0, h1, h2, h3;
  // max array size
  static constexpr size_t MAX_CHUNKSIZE = 65536;

  inline void md5(uint8_t* initial_msg, size_t initial_len)
  {
    ...
    uint8_t data_array[MAX_CHUNKSIZE] = {0};
    msg = data_array;  // also appends "0" bits
